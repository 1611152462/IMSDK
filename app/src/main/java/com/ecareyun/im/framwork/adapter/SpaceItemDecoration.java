 ...
 * 类描述：
 * 创建人：xiezheng
 * 创建时间：2018/12/11 下午2:51
 * 修改人：xiezheng
 * 修改时间：2018/12/11 下午2:51
 * 修改备注：
 */
public class SpaceItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public SpaceItemDecoration(int verticalSpace, int horizontalSpace) {
        this(verticalSpace, horizontalSpace, DEFAULT_COLUMN);
    }

    /**
     * @param verticalSpace   垂直间距（行间距）
     * @param horizontalSpace 水平间距（列间距）
     * @param column          列数
     */
    public SpaceItemDecoration(int verticalSpace, int horizontalSpace, int column) {
...
//        }
        if (column != DEFAULT_COLUMN) {
            float avg = (column - 1) * horizontalSpace * 1.0f / column;
