...
/*package*/final class MPushClient implements Client, AckCallback {
    ...
    public Future<Boolean> push(PushContext context) {
        ...
        PushMessage message = new PushMessage(context.getPushMsg().getContent().getBytes(), connection);
        message.addFlag(context.getAckModel().flag);
        ...
        return ackRequestMgr.add(message.getSessionId(),AckContext.build(context.getCallback()));
    }
